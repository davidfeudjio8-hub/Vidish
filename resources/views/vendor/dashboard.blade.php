            ...
            <div class="flex-1 overflow-y-auto pr-2 custom-scrollbar pb-6">
                <div class="flex flex-col xl:flex-row gap-6">
                    <div class="flex-1 space-y-6">
                        ...
                        {{-- Feedbacks Live --}}
                        <div class="space-y-4">
                            <h3 class="text-xs font-black text-gray-500 uppercase tracking-[0.2em]">Feedbacks en direct</h3>
                                ...
                                x-data="{
                                    ...
                                    async fetchComments() {
                                        try {
                                            ...
                                            this.comments = data;
                                            this.startAnimation();
                                        } catch (e) { console.log('API non prête'); }
                                    },
                                    startAnimation() {
                                        setInterval(() => {
                    ...
                    <div class="w-full xl:w-[400px] space-y-6">
                        <div class="glass-card p-6 rounded-[2.5rem]">
                            ...
                            <div class="h-48 w-full"><canvas id="vendorViewsChart"></canvas></div>
                        </div>
                        <div class="glass-card p-6 rounded-[2.5rem]">
                            ...
                            <div class="space-y-4">
                                @foreach ($dishes as $dish)
                                    <div class="flex items-center justify-between p-2 hover:bg-white/5 rounded-xl transition">
                                        ...
                                        <span class="text-[10px] text-gray-500">{{ $dish->views_count ?? 0 }} vues</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
